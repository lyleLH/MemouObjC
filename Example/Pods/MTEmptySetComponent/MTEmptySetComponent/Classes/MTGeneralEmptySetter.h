...
@interface MTGeneralEmptySetter : MTEmptySetter

/*
 设置: 标题文字字体、颜色 ｜ 标题富文本 ｜描述文字字体、颜色 ｜ 描述富文本 ｜ 占位图片 | 按钮状态
 */
...
////////////////////////////////////////////////////////////////
//MARK:-
//MARK:  指定某个状态下的设置，文字标题｜文字描述 ｜占位图片
//MARK:-
////////////////////////////////////////////////////////////////
...
- (void)setTapViewHandler:(void (^)(UIView *view))tapViewHandler forState:(MTEmptySetterState)state;

/** 设置state状态下的tapButtonHandler回调 */
- (void)setTapButtonHandler:(void (^)(UIButton *button))tapButtonHandler forState:(MTEmptySetterState)state;
