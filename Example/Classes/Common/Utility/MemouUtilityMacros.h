...
#ifndef MemouUtilityMacros_h
#define MemouUtilityMacros_h
...
#define kIPHONE_X_LATER ([MemouDeviceUtility isIphoneXLater])
//状态栏的高度
...
#define N_R(value) [MemouFontUtility fontWithDescription:_sfmt(@"noto_regular,%d",value)]
#define N_M(value) [MemouFontUtility fontWithDescription:_sfmt(@"noto_medium,%d",value)]
#define N_D(value) [MemouFontUtility fontWithDescription:_sfmt(@"noto_demi,%d",value)]
#define N_B(value) [MemouFontUtility fontWithDescription:_sfmt(@"noto_bold,%d",value)]
...
#define AutoFitWidth(val) ([MemouDeviceUtility fittedWidth:val])
#define AutoFitHeight(val) ([MemouDeviceUtility fittedHeight:val])
